...
knitr::opts_knit$set(root.dir="/Users/dic/Documents/Sarah Henrickson lab/20190815_PIK3CD-140106977_RNA-seq/diff_exp/")
```
...
cat(paste0("res_CD4Tn:  # Up = ", length(res_CD4Tn[which(res_CD4Tn$padj<=0.1 & res_CD4Tn$log2FoldChange>0),]$padj)),
paste0("  # Down = ", length(res_CD4Tn[which(res_CD4Tn$padj<=0.1 & res_CD4Tn$log2FoldChange<0),]$padj)),
paste0("\nres_CD4Tnn: # Up = ", length(res_CD4Tnn[which(res_CD4Tnn$padj<=0.1 & res_CD4Tnn$log2FoldChange>0),]$padj)),
paste0("  # Down = ", length(res_CD4Tnn[which(res_CD4Tnn$padj<=0.1 & res_CD4Tnn$log2FoldChange<0),]$padj)),
paste0("\nres_CD8Tn:  # Up = ", length(res_CD8Tn[which(res_CD8Tn$padj<=0.1 & res_CD8Tn$log2FoldChange>0),]$padj)),
paste0("  # Down = ", length(res_CD8Tn[which(res_CD8Tn$padj<=0.1 & res_CD8Tn$log2FoldChange<0),]$padj)),
paste0("\nres_CD8Tnn: # Up = ", length(res_CD8Tnn[which(res_CD8Tnn$padj<=0.1 & res_CD8Tnn$log2FoldChange>0),]$padj)),
paste0("  # Down = ", length(res_CD8Tnn[which(res_CD8Tnn$padj<=0.1 & res_CD8Tnn$log2FoldChange<0),]$padj)))
